...
function createLink(mapTitle, url) {
    ...
    // dojo.byId('embedLink').href = '<iframe width="800" height="500" src="' + url + '" frameborder="0" allowfullscreen></iframe>';
}
...
function createEditor() {
    ...
    if (editLayers.length > 0) {
        ...
        var templatePicker = editorWidget.templatePicker;
        templatePicker.showTooltip = false;
        dojo.style(templatePicker, {
            height:"98%",
            width: (configOptions.leftpanewidth -4) + 'px'
        });
