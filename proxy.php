<?php
  ...
  $serverUrls = array(
    ...
    array( 'url' => 'http://maps.fractracker.org/',        							'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://maps.fractracker.org/2.0/',       						'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://maps.fractracker.org/2.0/timeline/',        			'matchAll' => true, 'token' => '' ),

    array( 'url' => 'http://ft.maps.arcgis.com/',        							'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://services.arcgisonline.com/',        					'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://services.arcgisonline.com/ArcGIS/',        				'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://services.arcgisonline.com/ArcGIS/rest/',        		'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://services.arcgisonline.com/ArcGIS/rest/info',        	'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://services.arcgisonline.com/ArcGIS/rest/info/',        	'matchAll' => true, 'token' => '' ),

    array( 'url' => 'http://127.0.0.1',									        	'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://127.0.0.1:4444',							        	'matchAll' => true, 'token' => '' )
  );
  /***************************************************************************/
